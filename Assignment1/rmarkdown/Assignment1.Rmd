...
Though the final plot present the clear association, the preliminary and non-log-scaled plot gives us a clear look of outlining points. In the modified preliminary plot, it is shown that China and USA are the two top threatening source countries, whose invastion cost being either a threatened or source country are way higher than the rest of the countries. 
